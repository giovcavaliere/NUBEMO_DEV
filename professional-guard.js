...
(() => {
  ...
  async function authorize() {
    try {
      ...
      await loadScript('professional-services.js?v=nubemo40patientaccess02','Impossibile caricare i servizi Supabase dell’Area Professionista.');
      ...
      await loadScript('professional-patient-lifecycle-bridge.js?v=nubemo40patientaccess02','Impossibile preparare i contatti e l’accesso paziente.');
