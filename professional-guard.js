...
(() => {
  ...
  async function authorize() {
    try {
      ...
      await loadScript('professional-services.js?v=nubemo398recovery8','Impossibile caricare i servizi Supabase dell’Area Professionista.');
      ...
      await loadScript('professional-legacy-supabase-adapter.js?v=nubemo398recovery8','Impossibile preparare i dati dell’Area Professionista.');
      ...
      await loadScript('pro.js?v=nubemo398recovery8','Impossibile caricare l’Area Professionista.');
      ...
      await loadScript('professional-patient-management.js?v=nubemo398recovery8','Impossibile caricare la gestione dei pazienti.');
    } catch (error) {
