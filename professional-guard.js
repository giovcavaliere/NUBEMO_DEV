...
(() => {
  ...
  async function authorize() {
    try {
      ...
      await loadScript('professional-services.js?v=nubemo398recovery17','Impossibile caricare i servizi Supabase dell’Area Professionista.');
      ...
      await loadScript('professional-legacy-supabase-adapter.js?v=nubemo398recovery17','Impossibile preparare i dati dell’Area Professionista.');
      ...
      await loadScript('professional-patient-settings-supabase-bridge.js?v=nubemo398recovery17','Impossibile preparare le impostazioni dell’Area Paziente.');
      await window.nubemoProfessionalPatientSettingsBridge?.ready;
      await loadScript('professional-settings-supabase-bridge.js?v=nubemo398recovery17','Impossibile preparare le impostazioni del professionista.');
      await window.nubemoProfessionalSettingsBridge?.ready;
      await loadScript('professional-notes-supabase-bridge.js?v=nubemo398recovery17','Impossibile preparare le note del professionista.');
      await window.nubemoProfessionalNotesBridge?.ready;
      await loadScript('professional-documents-supabase-bridge.js?v=nubemo398recovery17','Impossibile preparare i documenti del paziente.');
      await window.nubemoProfessionalDocumentsBridge?.ready;
      await loadScript('professional-plans-supabase-bridge.js?v=nubemo398recovery17','Impossibile preparare i piani alimentari.');
      await window.nubemoProfessionalPlansBridge?.ready;
      await loadScript('professional-labs-supabase-bridge.js?v=nubemo398recovery17','Impossibile preparare gli esami del paziente.');
      ...
      await loadScript('pro.js?v=nubemo398recovery17','Impossibile caricare l’Area Professionista.');
      ...
      await loadScript('professional-patient-management.js?v=nubemo398recovery17','Impossibile caricare la gestione dei pazienti.');
      await loadScript('professional-access-privacy-supabase-bridge.js?v=nubemo398recovery17','Impossibile caricare Account e Privacy del paziente.');
    } catch (error) {
