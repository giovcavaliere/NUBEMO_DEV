    ...
    preparing=(async()=>{
      ...
      if(!window.nubemoProfessionalServices){
        if(!hasScript('professional-services.js')){
          await loadScript('professional-services.js?v=nubemo40clean02','Impossibile caricare i servizi necessari al nuovo paziente.');
        }
      ...
      if(!window.nubemoPatientLifecycleBridge){
        if(!hasScript('professional-patient-lifecycle-bridge.js')){
          await loadScript('professional-patient-lifecycle-bridge.js?v=nubemo40clean02','Impossibile preparare la creazione del paziente.');
        }
