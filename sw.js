const CACHE='nubemo-demo-v4.0-pathway19fix4';
const CORE=[
  ...
  './professional-nonactive-patient-bridge.js?v=nubemo-pathway19fix4',
  './professional-patient-groups-open-bridge.js?v=nubemo-pathway19fix4',
