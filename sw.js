const CACHE='nubemo-demo-v3.98-recovery5';
const CORE=[
  './',
  './index.html',
  './patient.html',
  './pro.html',
  './style.css?v=nubemo398recovery5',
  './diary-pdf.js?v=nubemo398recovery5',
  './app.js?v=nubemo398recovery5',
  './pro.js?v=nubemo398trend6',
  './monubi-ui.js?v=nubemo398recovery5',
  './supabase-client.js?v=nubemo398recovery5',
  ...
  './manifest.json?v=nubemo398recovery5',
