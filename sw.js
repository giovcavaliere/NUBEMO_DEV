const CACHE='nubemo-demo-v4.0-visitscouple-20260926a';
const CORE=[
  ...
  './app.js?v=nubemo-runtime-clean1',
  './pro.js?v=nubemo-runtime-clean1',
  './monubi-ui.js?v=nubemo-runtime-clean1',
  './config.js?v=nubemo-env-20260919',
  './supabase-client.js?v=nubemo-runtime-clean2',
  ...
  './patient-runtime-store.js?v=nubemo-runtime-clean1',
  './patient-diary-calorie-persistence-bridge.js?v=nubemo-pathway20b',
  './patient-document-read-supabase-bridge.js?v=nubemo40clean04',
  './patient-recovery-contract.js?v=nubemo40clean04',
  './patient-pathway-guard.js?v=nubemo-runtime-clean1',
  ...
  './professional-services.js?v=nubemo-visitscouple-20260926a',
  ...
  './professional-visits-supabase-bridge.js?v=nubemo-visitscouple-20260926a',
  ...
  './professional-pathway-history.js?v=nubemo-pathway19fix5',
  './professional-patient-groups.js?v=nubemo-pathway19fix3',
  './professional-nonactive-patient-bridge.js?v=nubemo-pathway19fix8',
  ...
  './professional-recovery-contract.js?v=nubemo-runtime-clean1',
  ...
  './professional-guard.js?v=nubemo-pathway20c',
