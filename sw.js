const CACHE='nubemo-demo-v4.0-patientlife05';
const CORE=[
  ...
  './professional-patient-lifecycle-bridge.js?v=nubemo40patientlife05',
  ...
  './professional-access-privacy-supabase-bridge.js?v=nubemo40account01',
  './professional-profile-privacy-supabase-bridge.js?v=nubemo40privacy02',
  './professional-guard.js?v=nubemo40patientlife05',
