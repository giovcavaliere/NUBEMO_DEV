const CACHE='nubemo-demo-v4.0-patientsync01';
const CORE=[
  ...
  './professional-agenda-supabase-bridge.js?v=nubemo40agenda01',
  ...
  './professional-patient-list-freshness.js?v=nubemo40patientsync01',
