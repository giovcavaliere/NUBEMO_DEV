const CACHE='nubemo-demo-v4.0-dashboardevent04';
const CORE=[
  ...
  './patient-diary-calorie-persistence-bridge.js?v=nubemo40calpersist02',
  ...
  './professional-dashboard-bootstrap.js?v=nubemo40dashboard04',
  './professional-patient-summary-lazy.js?v=nubemo40summary02',
  './professional-services.js?v=nubemo40lazy3a01',
  './professional-diary-calorie-supabase-bridge.js?v=nubemo40diary01',
  ...
  './professional-patient-list-freshness.js?v=nubemo40patientsync03',
  ...
  './professional-settings-supabase-bridge.js?v=nubemo40profile01',
  ...
  './professional-labs-supabase-bridge.js?v=nubemo40lazy3b01',
  './professional-patient-management.js?v=nubemo40phone01',
  './professional-patient-invite-guard.js?v=nubemo398improvement08',
  ...
  './professional-guard.js?v=nubemo40profile01',
