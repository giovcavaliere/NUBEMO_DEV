const CACHE='nubemo-demo-v4.0-pathway20c';
const CORE=[
  ...
  './patient-runtime-store.js?v=nubemo-pathway20b',
  ...
  './patient-pathway-guard.js?v=nubemo-pathway20b',
  ...
  './professional-clinical-pdf-pathway-bridge.js?v=nubemo-pathway19fix14',
