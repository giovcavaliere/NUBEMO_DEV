...
with me as (
  ...
  select
    d.id,d.patient_id,d.entry_date,d.weight_kg,d.water,d.coffee,d.sweetener,
    d.breakfast,d.morning_snack,d.lunch,d.afternoon_snack,d.dinner,d.sport,d.notes,
    d.breakfast_kcal,d.morning_snack_kcal,d.lunch_kcal,d.afternoon_snack_kcal,d.dinner_kcal,d.total_kcal,
    d.calorie_quality,d.calorie_calculated_at,d.created_at,d.updated_at
