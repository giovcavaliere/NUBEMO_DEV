...
(() => {
  ...
  async function ensureDependencies(){
    if(!window.nubemoProfessionalServices){
      if(!hasScript('professional-services.js'))await loadScript('professional-services.js?v=nubemo40clean01','Impossibile caricare i servizi paziente.');
    ...
    if(!window.nubemoProfessionalPatientSummaryLazy){
      if(!hasScript('professional-patient-summary-lazy.js'))await loadScript('professional-patient-summary-lazy.js?v=nubemo40clean01','Impossibile caricare il riepilogo paziente.');
