// NUBEMO — unifica le azioni della scheda paziente nel menu ⋯.
// Mantiene il flusso Modifica scheda e Termina percorso del bridge Supabase.
(() => {
  'use strict';
  ...
  function patch(){
    ...
    try{
      ...
      // Il pulsante esistente resta vivo come owner del flusso di modifica,
